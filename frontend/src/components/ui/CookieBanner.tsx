              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                  <motion.button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2 border border-neutral-300 rounded-lg text-neutral-700 hover:bg-neutral-50 transition-colors text-sm font-medium"
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 bg-neutral-600 text-white rounded-lg hover:bg-neutral-700 transition-colors text-sm font-medium"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <motion.button
                      onClick={handleAcceptNecessary}
                      className="flex-1 px-4 py-3 border border-neutral-300 text-neutral-700 rounded-xl hover:bg-neutral-50 transition-colors font-medium"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
